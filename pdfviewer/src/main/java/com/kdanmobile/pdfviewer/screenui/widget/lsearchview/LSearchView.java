package com.kdanmobile.pdfviewer.screenui.widget.lsearchview;
...
import com.kdanmobile.pdfviewer.screenui.widget.lsearchview.animation.alpha.AlphaAnimator;
import com.kdanmobile.pdfviewer.screenui.widget.lsearchview.animation.alpha.AlphaSupportAnimator;
import com.kdanmobile.pdfviewer.screenui.widget.lsearchview.animation.alpha.ViewAnimationTools;
import com.kdanmobile.pdfviewer.screenui.widget.lsearchview.animation.reveal.RevealAnimator;
import com.kdanmobile.pdfviewer.screenui.widget.lsearchview.animation.reveal.SupportAnimator;
import com.kdanmobile.pdfviewer.screenui.widget.lsearchview.animation.reveal.ViewAnimationUtils;
import com.kdanmobile.pdfviewer.utils.KeyboardUtils;


/**
 * Created by lion on 2016/11/4.
 * gitHub:https://github.com/onlynight/LSearchView
 */
...
public class LSearchView extends LinearLayout implements AlphaAnimator, RevealAnimator {
    ...
    private static final int DEFAULT_SEARCH_BAR_BG_COLOR = Color.argb(0xaa, 03, 0, 0);
    ...
    private void addDefaultView() {
        ...
        searchBarBaseLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, (int) searchBarHeight));
        ...
        LayoutParams btnBackLayoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT);
        btnBackLayoutParams.gravity = Gravity.CENTER_VERTICAL;
        ...
        btnBackLayout.setGravity(Gravity.CENTER_HORIZONTAL);
        btnBackLayout.setClickable(true);


        // edittext search content
        editSearch = new EditText(getContext());
        LayoutParams editSearchLayoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        editSearchLayoutParams.weight = 1;
        editSearch.setLayoutParams(editSearchLayoutParams);
        editSearch.setBackgroundResource(R.drawable.l_search_button_bg);
        ...
        LayoutParams btnSearchLayoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        btnBackLayoutParams.gravity = Gravity.CENTER_VERTICAL;
        ...
        btnSearchLayout.setGravity(Gravity.CENTER_VERTICAL);
...
//        addView(temp1);
    ...
    private void startAnimation() {
        boolean isEnd = ((searchViewBaseAnimator != null) && searchViewBaseAnimator.isRunning()) || ((searchViewAnimator != null) && searchViewAnimator.isRunning());
        if (isEnd) {
            return;
        }
        startAlphaAnimation();
...
//        setAlpha(defaultAlpha);
    ...
    public void showWithAnim() {
        ...
        /****** 当搜索框弹出后，显示输入框 ******/
        KeyboardUtils.showKeyboard(editSearch);
        startAnimation();
    }
