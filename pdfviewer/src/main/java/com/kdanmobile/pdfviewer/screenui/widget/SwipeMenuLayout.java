...
public class SwipeMenuLayout extends ViewGroup {
    private static final String TAG = "tlx/SwipeMenuLayout";
    ...
    public SwipeMenuLayout getmViewCache() {
        return mViewCache;
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            if (childView.getVisibility() != GONE) {
                if (i == 0) {//第一个子View是内容 宽度设置为全屏
                    ...
                    if (isLeftSwipe) {
                        ...
                        childView.layout(right - childView.getMeasuredWidth(), getPaddingTop(), right, getPaddingTop() + childView
                                .getMeasuredHeight());
        ...
        //Log.d(TAG, "onLayout() called with: " + "maxScrollGap = [" + maxScrollGap + "], l = [" + l + "], t = [" + t + "], r = [" + r + "], b = ["
        // + b + "]");
    }
