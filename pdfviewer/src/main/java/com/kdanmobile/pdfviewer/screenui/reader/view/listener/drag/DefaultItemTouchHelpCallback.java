...
/**
 * @classname：DefaultItemTouchHelpCallback
 * @author：liujiyuan
 * @date：2018/8/30 下午3:55
 * @description：RecyclerView的拖拽操作回调
 */
public class DefaultItemTouchHelpCallback extends ItemTouchHelper.Callback {
     ...
     * @param ：[canSwap]
     * @return : void
     * @methodName ：setSwapEnable created by luozhipeng on 2/11/17 10:56.
    ...
    public interface OnItemTouchCallbackListener {
         ...
         * @methodName ： created by xiaowumac on 2017/11/29 下午3:17.
         */
        void onMoved(RecyclerView.ViewHolder sourceViewHolder, int sourcePosition, int targetPosition);

        /**
         * @methodName： created by luozhipeng on 2/11/17 10:50.
